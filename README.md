...
```json
{"device_id":"EV-Diag-01","readings":[],"raw_dtc":[]}
```

`device_id` viene da NVS (`device_name`) o da MAC; `readings` e `raw_dtc` sono popolati quando è disponibile la libreria veicolo su LittleFS.
